package com.api_gateways.filter;
...
public class JwtAuthenticationFilter implements GlobalFilter, Ordered {
    ...
    private static final Map<String, List<String>> protectedEndpointsWithRoles = Map.of(
            "/micro1/api/v1/doctor/admin/register", List.of("ROLE_ADMIN"),"/micro2/api/v1/doctor/admin/login",List.of("ROLE_ADMIN"),
            "/micro2/api/v1/doctor/search",List.of("ROLE_USER","ROLE_ADMIN"),"/api/v1/doctor/search?specialization=general&areaName=cant",List.of("ROLE_USER","ROLE_ADMIN")
            ,"/micro1/api/v1/doctor/admin/appointments", List.of("ROLE_ADMIN")
    );
